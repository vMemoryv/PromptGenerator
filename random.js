//in the future I'll have to add a pruning mechanism:
//Then I'll add filtering options:
//ie: You can remove the Comedy and Romantic Comedy genres in your generations
//I'll add a submission page, where people can submit text of ideas and I'll manually approve them (they'll automatically be properly formatted)
//I'll add variants where depending on type of fic lengths, the prompts will change; ie: from action to word, etc.
...
//   res.text().then((resTwo) => {
//     console.log(resTwo);
//   });
// });
//called promise chaining
//what are promises - what is async await;
...
headerTwo.textContent =
  ...
  "\n" +
  "Location: " +
  getRandomItem(settings) +
  "\n" +
  "Object: " +
  getRandomItem(objects);

var headerThree = document.createElement("h3");

sw.appendChild(headerThree);
...
var headerFour = document.createElement("h3");

se.appendChild(headerFour);

headerFour.textContent =
  "Short Story\n\n\n" +
  "Genre: " +
  getRandomItem(genres) +
  "\n" +
